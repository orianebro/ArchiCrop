...
class ArchiCrop:
    ...
    def __init__(self, 
        ...
        self.leaf_senescence = leaf_senescence
    ...
    def define_development(self):
        ...
        """
        self.g = thermal_time(self.g, self.phyllochron, self.plastochron, self.leaf_duration, self.stem_duration, self.leaf_senescence)
